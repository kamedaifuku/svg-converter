// Generated by scripts/prepare-vtracer.mjs. See THIRD_PARTY_NOTICES.md.
 ...
 * @returns {string}
 */
function vectorize_bytes(data, options) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
function vectorize_rgba(data, width, height, options) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
